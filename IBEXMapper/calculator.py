...
class Calculator:
    ...
    def rotateGridByTwoRotations(self, x_mesh: np.ndarray, y_mesh: np.ndarray, z_mesh: np.ndarray, central_rotation: np.ndarray, meridian_rotation: np.ndarray) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
